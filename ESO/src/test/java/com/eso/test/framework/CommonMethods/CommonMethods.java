package com.eso.test.framework.CommonMethods;
...
public class CommonMethods extends SetBrowser{
    ...
    public void clickElement(WebElement elementName) throws InterruptedException {
        //webDriverWait.until(ExpectedConditions.visibilityOf(elementName)); 30/06/2020
